...
class ResourceExceptionHandlerTest {
    ...
    @Test
    void dataIntegrityViolationExcepion() {

        ResponseEntity<StandardError> response = resourceExceptionHandler
                .dataIntegrityViolationExcepion(new DataIntegrationViolationException(EMAIL_JA_CADASTRADO),
                        new MockHttpServletRequest());
        ...
        assertNotEquals("/api/users/2", response.getBody().getPath());
